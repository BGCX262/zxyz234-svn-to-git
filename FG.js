	...
	$('#zmc_message_list_ul').find('li').each(function(index){			        
			...
			function next_link(id,type){
				if(actions.length>0) {
				  ...
				  if (showEndAlert) alert("done");
				}
			}
			var out = 'â˜…LOC@Sâ˜… - FastGiftClicker v2<br><br><table border="1"><tr><th>Item</th><th>Count</th><th>Click All</th><th>Click<br><font size="-2">(Accept & Thank only)</font></th><th>Ignore all</th></tr>'
+'<tr><th>&nbsp;</th><th>&nbsp;</th><th><a href="#" class="sexy_button_new purple short" id="juansinho_all_hupchen"><span><span>HÃ¼pchen-All</span></span></a>'
+'</th><th><a href="#" class="sexy_button_new purple short" id="juansinho_thank_hupchen"><span><span>HÃ¼pchen-Accept & Thank</span></span></a></th><th>&nbsp;</th></tr>';
